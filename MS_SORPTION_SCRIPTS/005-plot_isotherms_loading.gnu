...
p f1a u 1:((($2/8)/mw)*1000) w p ls 1 title "CH_4,current",\

p f2a u 1:((($2/8)/mw)*1000) w p ls 1 title "CH_3Cl,current",\

p f3a u 1:((($2/8)/mw)*1000) w p ls 1 title "CH_2Cl_2,current",\

p f4a u 1:((($2/8)/mw)*1000) w p ls 1 title "CHCl_3,current",\

p f5a u 1:((($2/8)/mw)*1000) w p ls 1 title "CHCl_4,current",\
...
p f6a u 1:((($2/8)/mw)*1000) w p ls 1 title "C_2H_6,current",\

p f7a u 1:((($2/8)/mw)*1000) w p ls 1 title "C_2H_4Cl_2,current",\

p f8a u 1:((($2/8)/mw)*1000) w p ls 1 title "C_2H_4,current",\

p f9a u 1:((($2/8)/mw)*1000) w p ls 1 title "C_2HCl_3,current",\

p f10a u 1:((($2/8)/mw)*1000)  w p ls 1 title "C_2Cl_4,current",\
...
p f11a u 1:((($2/8)/mw)*1000) w p ls 1 title "Cl_2,current",\

p f12a u 1:((($2/8)/mw)*1000) w p ls 1 title "HCl,current",\
